...
class AnswerBoxUnitTest(object):
    ...
    @property
    def box_indexes_plus_one(self):
        '''
        Return box indexes, with the <x> coordinate incremented by 1
        '''
        return [(x+1, y) for (x,y) in self.box_indexes]
    ...
    def __add__(self, other):
        ...
        both_indexes = self.box_indexes + other.box_indexes_plus_one
